...
const ordinaryStages = [
  ...
  ['Agent completion sound regression', nodeCommand, ['--test', 'tests/agent-completion-sounds.test.mjs', 'tests/agent-completion-sound-pending.test.mjs', 'tests/agent-sound-initialization-indicator.test.mjs']],
