...
test('generated userscript stays tracked while RepoWorkflow owns artifact handling', async () => {
...
test('canonical CI carries development and stable modes through one finalizer', async () => {
  ...
  assert.match(workflow, /RepoWorkflow\/repo_workflow\.py stable-preflight/);
