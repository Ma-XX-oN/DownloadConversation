...
EXPECTED_RESET_SHA256 = '4592bb94353fd5416a7b372e0e113b66b6e4deeab43338a50505fbfeac11716c'
...
reset_bytes = base64.b64decode(RESET_ICON_BASE64, validate=True)
reset_hash = hashlib.sha256(reset_bytes).hexdigest()
if reset_hash != EXPECTED_RESET_SHA256:
  raise SystemExit(
    f'replacement reset asset hash mismatch: expected {EXPECTED_RESET_SHA256}, got {reset_hash}')
if len(reset_bytes) != 1581:
  raise SystemExit(f'replacement reset asset size mismatch: expected 1581, got {len(reset_bytes)}')
