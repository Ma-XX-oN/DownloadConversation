...
source = replace_once(
  ...
  "      #${PANEL_ID} .tm-row{display:flex;gap:10px;align-items:center;flex-wrap:wrap;margin-top:10px}\n"
  "      #${PANEL_ID} .tm-communication-log-row .tm-label{flex-basis:100%}\n"
  "      #${PANEL_ID} .tm-log-name-viewport{flex:1 1 160px;min-width:0;overflow:hidden;border:1px solid #666;border-radius:9px;background:#292929;color:#fff;box-sizing:border-box}\n"
